...
internal static class SchemaVersionOneFixture
{
  ...
  public static async Task CreateAsync(string path)
  {
    ...
    command.CommandText = $"""
            ...
            INSERT INTO application_metadata VALUES (1, 'com.ozzifan.tww3-companion.workspace', 1);
            INSERT INTO schema_migrations VALUES (1, '2026-07-18T00:00:00.0000000+00:00');
